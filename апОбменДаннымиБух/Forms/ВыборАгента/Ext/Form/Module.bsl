...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ТекОбъект.ЕстьСвойстваСтруктуры(СтррКонтекст, СтрСвойства) Тогда
...
&НаКлиенте
Процедура ОткрытьФормуОбработки(ИмяФормы, СтррПараметры = Неопределено)
	...
	ОткрытьФорму(СтррКонтекст.ПутьКФорме + ИмяФормы, СтррПараметры, ЭтаФорма);
